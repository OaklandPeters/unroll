...
For an even more direct equivalent to multi-line comprehensions, try the ``@compre()`` decorator, which immediately invokes the resulting function, resulting in a variable rather than a function::
